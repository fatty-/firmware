...
## 固件特性
    ...
    3. 默认advancedtomato主题，集成material、bootstrap满足个性化需求
    4. 集成常用软件：S^S、kcptun、广告过滤adbyby、Ngrok、pptp openvpn服务器、webshell、dnspod、wifidog、aria2、硬盘自动休眠、单wan多拨、多线负载均衡、多ISP策略路由、USB打印服务器、家长管理、miniDlan、定时唤醒、百度网盘同步。。。
    5. IPV6支持、石像鬼QOS
...
## 最近更新 2016-09-13
    1bf6bc0c1626118ba59b0a9bbaeaf2b3 *openwrt-x86-64-combined-ext4.img

专为NUC优化，理论上也支持其它单网口机器，需要配合VLAN交换机使用，交换机设置方法：

<http://koolshare.cn/thread-63503-1-1.html>