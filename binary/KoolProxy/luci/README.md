...
<font color=red>安装前请确保你的路由器上有**openssl,ipset,dnsmasq-full,diff**这几个软件包，特别是openssl，没有的话就不能正常生成证书，如果没有ipset,dnsmasq-full,diff，黑名单模式也会出现问题！以上包如果确实请自行用opkg命令安装 </font></br>
</br>
## 开始安装：
